...
/*------------------------------------------------Fenetre----------------------------------------*/
   ...
   /*------------------------------------------------Fenetre----------------------------------------*/
/*--------------------------------------------------Méthodes------------------------------------------*/
    public void AjouterFormation() throws IOException {
      
       Parent newRoot;
       Scene newScene;
       newRoot = FXMLLoader.load(getClass().getResource("/dgsescuela/Formations/FXMLAjouter.fxml"));
       newScene = new Scene(newRoot);

       StageFor= new Stage();;
       StageFor.setTitle("Ajouter Formation");
       StageFor.setScene(newScene);
       StageFor.showAndWait();
      
    }
     public void ModifierFormation() throws IOException {
    ...
    selectCondidat();
       ...
       Parent newRoot;
       Scene newScene;
       newRoot = FXMLLoader.load(getClass().getResource("/dgsescuela/Formations/FXMLModifier.fxml"));
       newScene = new Scene(newRoot);

       StageFor= new Stage();;
       StageFor.setTitle("Modifier formation");
       StageFor.setScene(newScene);
       StageFor.showAndWait();

    }
     public void SupprimerFormation() throws IOException {

   selectCondidat();
   
        Parent newRoot;
        Scene newScene;
       newRoot = FXMLLoader.load(getClass().getResource("/dgsescuela/Formations/FXMLConfermationSuppression.fxml"));
       newScene = new Scene(newRoot);

       StageFor= new Stage();;
       StageFor.setTitle("Supprimer formation");
       StageFor.setScene(newScene);
       StageFor.showAndWait();
